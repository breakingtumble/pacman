...
def betterEvaluationFunction(currentGameState: GameState) -> float:
  ...
  # Розрахуємо дистанцію між пакменом та привидом, якщо пакман знаходиться на позиції привида,
  # то штрафуємо його, якщо дистанція < 6 - також штраф.
  GhostDist=[]
  ...
  # Додаємо бали за їжу, яка знаходиться на полі, а також розраховуємо дистанції до неї
  ...
  # Штраф за знаходження далеко від їжі
